...
function Noble.Animation.new(__view)
	...
	---@param __loop? boolean 'If you want a state to "freeze" on its final frame, instead of looping, enter `false` here. Default: true'
	---@param __onComplete? any 'This function will run when this animation is complete. Be careful when using this on a looping animation!'
	---@param __frameDuration? integer 'This is the number of ticks between each frame in this animation. If not specified, it will be set to 1. Default: 1'
	--- @usage
	...
	---@param __x? number ' Default: 0'
	---@param __y? number ' Default: 0'
	---@param __direction? any 'Override the current direction. Default: self.direction'
